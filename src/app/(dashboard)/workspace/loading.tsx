...
export default function WorkspaceLoading() {
  return (
    <div className="min-h-screen bg-[var(--brand-bg)] text-[var(--brand-text-primary)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl bg-[var(--brand-surface-card)] border border-[var(--brand-border)] rounded-2xl shadow-2xl p-0 z-10 h-[min(90vh,48rem)] flex flex-col items-center justify-center overflow-hidden">
